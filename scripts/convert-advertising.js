...
// Read the Advertising questions text file
const advertisingText = fs.readFileSync(
  "c:/Users/manue/Downloads/Advertising.txt",
  "utf8"
);

const questions = [];
const lines = advertisingText.split("\n");
...
const outputPath = path.join(
  __dirname,
  "../src/data/fbla-questions/advertising.json"
);

fs.writeFileSync(outputPath, JSON.stringify(questions, null, 2));

console.log(
  `Successfully converted ${questions.length} Advertising questions to JSON`
);

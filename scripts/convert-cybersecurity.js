...
// Read the Cybersecurity questions text file
const cybersecurityText = fs.readFileSync(
  "c:/Users/manue/Downloads/Cybersecurity.txt",
  "utf8"
);

const questions = [];
const lines = cybersecurityText.split("\n");
...
const outputPath = path.join(
  __dirname,
  "../src/data/fbla-questions/cybersecurity.json"
);

fs.writeFileSync(outputPath, JSON.stringify(questions, null, 2));

console.log(
  `Successfully converted ${questions.length} Cybersecurity questions to JSON`
);

      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-[#FF3B9A]">Learning</span>{' '}
            Converge
          </motion.h1>
          ...
          >
            Experience our cutting-edge mini-games powered by AI. Enhance your skills, 
            track your progress, and revolutionize your learning journey.
          </motion.p>
          ...
          >
            <Link href="/mini-games">
              <Button 
                className="bg-[#6366F1] hover:bg-[#6366F1]/90 text-white px-8 h-12 text-lg rounded-full"
              >
                Try Mini-Games
              </Button>
            </Link>
